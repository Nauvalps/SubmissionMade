package com.bangkit.submissionmade1.core.di

import androidx.room.Room
import com.bangkit.submissionmade1.core.data.source.NewsRepository
import com.bangkit.submissionmade1.core.data.source.local.LocalDataSource
import com.bangkit.submissionmade1.core.data.source.local.room.NewsDatabase
...
val databaseModule = module {
    ...
    single {
        val passphrase: ByteArray = SQLiteDatabase.getBytes("made_2_nauval".toCharArray())
